...
Nagy méretekben üzembe helyezett megoldásokat szeretne. Szeretnénk odahozni. Először is vegyük át az eszközök( tehát hologramok) üzembe helyezésének lépéseit, hogy értéket érjenek el a vegyes valóság célforgatókönyvében. Akár a D365 Remote Assistet, az útmutatókat, akár egy Ön által létrehozott, vegyes valóságú Azure-beli, szolgáltatásra képes alkalmazást használ – a közös üzembe helyezési forgatókönyvek végigvezetik a folyamaton.

Ön lehet egy üzleti döntéshozó, it-szakértő vagy innovációs csapat, amely vállalaton HoloLens vállalaton belül. A koncepció igazolása és a skálázható üzembe helyezés között az üzembe helyezési útmutatóinknak van értelme HoloLens az it-infrastruktúrán belül – függetlenül attól, hogy mekkora vagy kicsi. A leggyakoribb telepítési forgatókönyvek a következők:
