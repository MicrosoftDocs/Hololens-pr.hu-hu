...
ms.locfileid: "122979372"
---
# <a name="set-up-hololens-as-a-kiosk"></a>A HoloLens beállítása kioszkként

## <a name="what-is-kiosk-mode"></a>Mi az a kioszkmód?

A kioszkmód egy olyan funkció, amellyel szabályozható, hogy mely alkalmazások jelennek meg a Start menüben, amikor egy felhasználó bejelentkezik a HoloLens. Két támogatott forgatókönyv íme:
...
4. Állapítsa meg, hogy a kioszkmód a HoloLens kiépítési csomagok vagy a Mobile Eszközkezelés (MDM) kiszolgálóján keresztül lesz-e alkalmazva.
...
2. [Microsoft Intune többalkalmazásos kioszksablon használata](hololens-kiosk.md?tabs=uimak#steps-in-configuring-kiosk-mode-for-hololens)
...
A kioszkmód az Eszközportál REST API-ján keresztül állítható be úgy, hogy post parancsot ad az /api/holographic/kioszkmode/settings elemhez egy kötelező lekérdezési sztringparaméterrel ("kioszkModeEnabled" "true" (igaz) vagy "false" (hamis) értékkel), valamint egy opcionális paraméterrel ("startupApp" egy csomagnév értékével). Ne feledje, hogy Eszközportál csak fejlesztőknek készült, és nem szabad engedélyezni a nem fejlesztői eszközökön. A REST API jövőbeli frissítések/kiadások változhatnak.
...
- A Holographic Windows előtt a 20H2 - HoloLens az összes alkalmazás 20H2-es Start menü.
