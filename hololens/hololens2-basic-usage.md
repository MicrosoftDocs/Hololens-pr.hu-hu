...
description: Fedezze fel a vegyes valóságot, és ismerkedés ezzel az útmutatóval arról, hogyan használhatja HoloLens 2 eszközt a saját kezűleg.
...
- A 2. HoloLens hologramok használata a kéz és a hang használatával
...
A holografikus képkockák olyan pozícióba ékezetesek, ahol a szem a legérzékenyebb a részletekre, a átlátó objektívek pedig tisztán hagyják a periférialátást. A térbeli hangokkal a hologramokat akkor is figyelheti, ha az Ön mögött van. Mivel a HoloLens tisztában van a fizikai környezetével, hologramokat is helyezzen valós objektumokra, például táblákra és falakra.

A HoloLens való ismerkedni sokban olyan, mint az intelligens telefon használata. A kézzel holografikus ablakokat, menüket és gombokat is használhat.  
...
> Használja az indítási kézmozdulatot a **Start menüre,** vagy mondja ki a "Ugrás az indításhoz" szót, és válassza a **Tippek.**
...
Ha egy helyi **menüt** szeretne, például az alkalmazáscsempéken található menüt a Start menü **koppintson** és tartsa lenyomva, ahogy az érintőképernyőn is.
...
Ha nincsenek hologramok a kéz közelében, az **érintéses** kurzor automatikusan el fog rejteni, és a kéz sugárai megjelennek a kéztől.  A kézi sugárokkal távolról kommunikálhat a hologramokkal.
...
1. Az elem megcélzott elemét egy, a telefonról származó kézbefedő sugár használatával. Nem kell felkelni a teljes karot, alacsonyan tarthatja a könyökét, és kényelmesen hagyhatja.
1. Irányítsa fel az indexaját közvetlenül a felső határ felé.
1. A légi **koppintásos kézmozdulat** végrehajtásához csippentse össze a hüvelyk- és indexaját, majd engedje el őket gyorsan.
...
Ha egy hologramot vagy görgetőalkalmazás-tartalmat fog a kéz sugár **használatával,** kezdjen egy légi koppintással, de ne szabadodjon ki, hanem tartsa együtt az összecsukott arcokat.
...
A **Start menü** a Start kézmozdulattal zárhatja be, Start menü megnyitott fájl.  A következőt is Start menü" bezárásként.

### <a name="one-handed-start-gesture"></a>Egy egy szándékú indítási kézmozdulat

> [!IMPORTANT]
> Az egy egy szándékú Indítás kézmozdulat a következő:
>
...
A telepített alkalmazásokat a [](holographic-home.md) Start menü, a további alkalmazásokat pedig a HoloLens találja [Microsoft Store.](holographic-store-apps.md)

Ahogy Windows számítógép is mindig az asztalon kezdi a felhasználói élményt, a HoloLens mindig a vegyes valóság **kezdőlapon** indul, amikor be van kapcsolva.  A Start menü alkalmazásablakokat, alkalmazásindítókat és 3D-tartalmakat nyithat meg és helyezzen el a vegyes valóság kezdőlapján. A fizikai térben való elhelyezésüket a HoloLens.

Nyissa meg **Start menü** alkalmazást, majd válassza **Gépház** alkalmazás csempéjét. Megnyílik egy alkalmazásablak az Ön előtt.

Gépház 2D-s alkalmazásablakot HoloLens **alkalmazásalkalmazásra példa.**  Nagyon hasonlít a pc-n Windows alkalmazáshoz.
...
Tippek egy példa egy modern **alkalmazásra.** A modern alkalmazások elhoznak a vegyes valóságból, amikor az fut, és az lesz az egyetlen alkalmazás, amit lát.  A kilépéshez meg kell hoznia a Start menü a **mixed reality kezdőlap gombját** alul.
...
- A hologram átméretezése érdekében mozgassa közelebb vagy távolról a kézzel.
...
Hologramok és az alkalmazásablakok ott maradnak, ahová a világba helyezte őket.  Ez nem mindig kényelmes, ha mozgásban kell lennie, és azt szeretné, hogy az alkalmazás látható maradjon. Ha azt kéri egy alkalmazástól,  hogy kezdje el vagy állítsa le a követést, válassza az alkalmazás ablakának jobb felső sarkában (a Bezárás gomb mellett) a Követés **gombra** kattintva.  A következő alkalmazásablak egy modern alkalmazásba is beemelődhet.

## <a name="use-hololens-with-your-voice"></a>A HoloLens használata a hangjával

A hangjával a legtöbb olyan dolgot is meg lehet tenni, mint a HoloLens, például egy gyors fényképen vagy egy alkalmazás megnyitásán.
...
Egyes ügyfelek gyorsabban "gépelnek" a virtuális billentyűzeten a begépelni kívánt szó alakjának megformálása által. A [Windows Holographic 21H1](hololens-release-notes.md#windows-holographic-version-21h1)verziójával mostantól pöccintsen egyszerre egy szót úgy, hogy a holografikus billentyűzet síkján végigadja az ujjlenyomata hegyét, elforgatja a szó alakját, majd a billentyűzet síkján eltolást kelti az ujjlenyomata hegyét. Pöccintéssel anélkül pöccinthet a szavak után, hogy le kellene nyomni a szóközt, ha a szavak között eltávolítja az ujját a billentyűzetről. A funkció akkor működik, ha pöccintéssel követi az ujját a billentyűzeten.
