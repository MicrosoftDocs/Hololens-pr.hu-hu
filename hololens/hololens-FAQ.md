...
description: Kérdése van a hologramok HoloLens vagy azokkal való interakcióról?  Ez a cikk gyors választ és további forrásokat tartalmaz.
...
- A hibaelhárítás előtt győződjön meg arról, HoloLens díj fel van [számolva](hololens2-charging.md) (legalább egy óra után). 
...
- [Hologramok eltűnnek, vagy más hologramba vagy objektumokba vannak ásva](#holograms-disappear-or-are-encased-in-other-holograms-or-objects)
...
- Próbálja ki a környezetet, és lásson a HoloLens, hogy jobban átolvassa őket.
- Ha sok hologramot helyezett el, próbáljon meg eltávolítani néhányat.

Ha továbbra is problémákba merült fel, próbálja meg a Indítóalkalmazást futtatni. Ez az alkalmazás HoloLens csak azért, hogy a hologramok a lehető legjobban kinézhessenek. Ehhez a Rendszer-segédprogramok **Gépház**  >    >  **meg.** A **Felberekedő** alatt válassza a **Open Egyedek lehetőséget.**

[Vissza a listához](#list)

## <a name="finding-your-space-message"></a>"A hely megkeresve" üzenet

Amikor HoloLens vagy helyet tölt be, egy rövid üzenet jelenik meg, amely a következőt mondja: "A hely megkeresve". Ha ez az üzenet néhány másodpercnél tovább jelenik meg, egy másik üzenet jelenik meg a képernyő alatt Start menü a következő szöveg jelenik meg: "Still looking for your space".

Ezek az üzenetek azt HoloLens, hogy nem lehet leképezni a tárhelyet. Ebben az esetben megnyithat alkalmazásokat, de nem tud hologramokat a környezetében eltenni.
...
- Győződjön meg arról, hogy erős Wi-Fi jellel. Ha olyan új környezetbe lép, amely nem rendelkezik Wi-Fi vagy gyenge Wi-Fi jellel, HoloLens nem fogja megtalálni a teret. Ellenőrizze a Wi-Fi kapcsolatát a **Gépház**  >  **&amp; Wi-Fi hálózatán**  >  keresztül.
...
- Győződjön meg arról, hogy egy hálózati Wi-Fi csatlakozik. Ha nem csatlakozik Wi-Fi-hálózathoz, HoloLens nem tudja azonosítani és betölteni az ismert tárhelyet.
- Járja körül a helyiségeket, HoloLens át tudja-e ásni a környezetet. A már beolvasott elemek vizsgálatának ellenőrzéshez koppintson a levegőre a leképezési háló ábrának a felfedéséhez.
- Ha új tárhelyet kell létrehoznia, csatlakozzon a Wi-Fi-hálózathoz, majd indítsa újra a HoloLens.
- Ha látnia kell, hogy a megfelelő terület aktív-e, vagy manuálisan be kell töltenie egy szóközt, a Gépház   >  **térben.**  >  
...
## <a name="holograms-disappear-or-are-encased-in-other-holograms-or-objects"></a>Hologramok eltűnnek, vagy más hologramba vagy objektumokba vannak ásva
...
Hologramok más hologramok vagy objektumok, például a fal is blokkolhatja vagy be lehet azokat bevetni. Ha ez történik, próbálkozzon az alábbi javításokkal:
...
- Ha a hologram egy falba van ásva, válassza a **Beállítás** lehetőséget, majd haladjon a fal felé, amíg meg nem jelenik a hologram. Koppintson és tartsa lenyomva, majd húzza előre és ki a hologramot a falról.
...
Ha nagyon közel van egy falhoz, vagy ha HoloLens még nem vizsgálta be a falat, a következő teremben is láthat hologramokat. A fal beolvasására álljon egy-három méter közé a faltól, és tekintsen rá.
...
## <a name="after-placing-a-hologram-on-a-wall-it-seems-to-float"></a>Miután elhelyez egy hologramot egy falon, úgy tűnik, hogy lebegőg
...
- Ha a probléma továbbra is fennáll, futtassa a Tanácsadó alkalmazást. Ezt a System **Utilities Gépház**  >    >  **találja.**
...
1. Engedélyezze a teljes telemetriát a **Gépház** app -> **Privacy**  ->  **Diagnostics &**  visszajelzésen keresztül, és a Választható diagnosztikai adatok alatt győződjön meg arról, hogy a kapcsoló Be van **állítva**
1. Szerezze be a legújabb hologramméret- és stabilitási javításokat a [holographic Windows (20H2 vagy újabb) verzióra való frissítésével.](hololens-release-notes.md#windows-holographic-version-20h2) A frissítés után hajtsa végre a következőket:
    ...
    1. Hozzon létre egy új térképet a térről úgy, hogy HoloLens, és körbe járja a helyiséget, és a tér összes felületét és felületét nézi. Ezt 2–3 percig tegye meg.
