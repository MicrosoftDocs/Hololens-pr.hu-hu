...
ms.locfileid: "121858446"
---
# <a name="manage-user-identity-and-sign-in-for-hololens"></a>Felhasználói identitás és bejelentkezés kezelése a HoloLens

> [!NOTE]
> Ez a cikk technikai útmutató az it-szakemberek és a műszaki szakemberek számára. Ha további útmutatásra van HoloLens, olvassa el a következőt: " HoloLens beállítása[(1. generációs)](hololens1-start.md)" vagy " A HoloLens[beállítása "](hololens2-start.md).

Mint minden Windows, HoloLens mindig felhasználói környezetben működik. Mindig van felhasználói identitás. HoloLens szinte ugyanúgy kezeli az identitást, mint más Windows eszközök. Ez a cikk egy, a HoloLens identitással HoloLens referenciája a többi Windows kapcsolatban.
...
Alapértelmezés szerint, mint minden Windows 10, újra be kell jelentkeznie, amikor a HoloLens újraindul vagy készenléti állapotból újraindul. Az alkalmazással Gépház módosíthatja ezt a viselkedést, vagy a viselkedést csoportházirend vezérelheti.

### <a name="linked-accounts"></a>Összekapcsolt fiókok

Ahogy az asztali verzióban Windows, további webfiók hitelesítő adatokat is csatolhat a HoloLens fiókjához. Az ilyen összekapcsolás megkönnyíti az erőforrások hozzáférését az alkalmazásokon belül vagy alkalmazásokon belül (például az Áruházban), vagy a személyes és munkahelyi erőforrásokhoz való hozzáférés összevonását. Miután csatlakoztatta a fiókot az eszközhöz, engedélyt adhat az eszköz használatára az alkalmazásoknak, hogy ne külön-külön kell bejelentkeznie az egyes alkalmazásokba.
...
Alkalmazásfejlesztőként a Windows [Account Manager API-k](/uwp/api/Windows.Security.Authentication.Web.Core)használatával kihasználhatja a csatolt identitásokat a HoloLens-on, ahogyan más Windows is tenné. Az API-khoz elérhető néhány kódminta a GitHub: [Webfiók-felügyeleti minta.](https://go.microsoft.com/fwlink/p/?LinkId=620621)
...
További információt [a biometrikus követelmények és](/windows-hardware/design/device-experiences/windows-hello-biometric-requirements) specifikációk Windows Hello információkért. További információ a [Windows Hello](/windows-hardware/design/device-experiences/windows-hello) és [Windows Hello üzleti verzióról.](/windows/security/identity-protection/hello-for-business/hello-identity-verification) 
