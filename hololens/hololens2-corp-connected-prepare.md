...
description: A Dynamics 365-útmutatók segítségével megtudhatja, hogyan készítheti elő HoloLens 2 eszköz vállalati csatlakoztatott hálózaton keresztüli regisztrálását.
...
Ha a hálózata még nem támogatja az SCEP-t, vagy nem biztos benne, hogy a hálózata megfelelően van beállítva az SCEP-hez az Intune-nal, akkor a Configure  [infrastructure to support SCEP with Intune](/mem/intune/protect/certificates-scep-configure)(Infrastruktúra konfigurálása az SCEP Intune-nal való támogatásához) referenciát.
...
A legtöbb vállalati intranetes hálózat proxyt használ a külső forgalom kezelésére. A HoloLens 2-es porton konfigurálhat proxykiszolgálót Ethernet-, hálózati és VPNWi-Fi kapcsolatokhoz.

A proxynak többféle típusa és a proxy konfigurálható. Ebben az útmutatóban úgy döntünk, hogy a **Wi-Fi proxyt választjuk, PAC URL-címen** keresztül adhatja meg és MDM-en keresztül helyezheti üzembe. Ez azzal jár, hogy az MDM-en keresztül történik az automatikus üzembe helyezés, a PAC-fájl frissítése a kiszolgáló:port konfiguráció helyett, végül pedig egy proxy használata Wi-Fi proxy konfigurálásához, hogy csak egyetlen Wi-Fi-kapcsolatra legyen alkalmazva, hogy az eszközök akkor is használhatók, ha egy másik helyen csatlakoznak.

További információ a proxybeállításokról a Windows 10: [Create a Wi-Fi profile for devices in Microsoft Intune - Azure](/mem/intune/configuration/wi-fi-settings-configure).
...
Az alkalmazásokat többféleképpen is üzembe helyezheti HoloLens 2 eszközön. Az alkalmazások telepíthetők közvetlenül az MDM,a Microsoft Store Vállalatoknak (MSfB) vagy közvetlenül telepíthetők egy kiépítési csomagon keresztül. Az útmutató kedvéért az MDM-en keresztül telepítünk alkalmazásokat a szükséges alkalmazástelepítés használatával. Ez lehetővé teszi az LOB-alkalmazások automatikus letöltését a HoloLens eszközökre, miután befejezték a regisztrációt.
